...
mysqli_select_db($conn, "tblstudents01") or die("Cannot select bca database");
//----------------------------------Save Mode Starts Here---------------------------------
if(isset($_REQUEST["mode"])=="save"){

    //echo "insert into tblStudent values('". $_POST["txt_regno"] ."','". 
$_POST["txt_sname"] ."','". $_REQUEST["cmb_dept"] ."','".  $_POST["cmb_year"] ."','". $_POST["cmb_sem"] ."')";
//die();
mysqli_query($conn, "insert into tbl_Student01 values('". $_POST["txt_regno"] ."','". $_POST["txt_sname"] ."','". $_REQUEST["cmb_dept"] ."','". $_POST["cmb_year"] ."','".  $_POST["cmb_sem"] ."')");
