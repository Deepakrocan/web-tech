<html>
    ...
    <body>
        <form name="frm" method="post" action="sample.php">
             <table border="0" cellpadding="0" cellspacing="0" width="400"> <tr height="40">
            ...
            <td>:&nbsp;<input type="text" value=""  name="txt_sname" /></td></tr><tr height="40">
        ...
        <tr height="40">
            ...
            <tr height="60"><td colspan="2" align="center">
